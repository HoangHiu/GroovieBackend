...
public class PlaylistServiceImpl implements IPlaylistService {
    ...
    @Override
    public PlaylistDtoOut createPersonalPlaylist(PLaylistDtoIn pLaylistDtoIn) {
    ...
    @Override
    public String addSongsToPlaylist(UUID playlistId, List<String> songIds) throws ApiCallException {
        Playlist playlist = getPLaylistfromId(playlistId);
        ...
        return "Added songs with ids: " + songIds + " to playlist with id: " + playlistId;
    }
