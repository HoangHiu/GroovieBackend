...
public interface IPlaylistService {
    ...
    PlaylistDtoOut createPersonalPlaylist(PLaylistDtoIn pLaylistDtoIn);
    ...
    String addSongsToPlaylist(UUID playlistId, List<String> songIds) throws ApiCallException;
